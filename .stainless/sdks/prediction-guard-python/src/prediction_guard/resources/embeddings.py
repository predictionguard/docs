...
class EmbeddingsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        input: Union[str, SequenceNotStr[embedding_create_params.InputUnionMember1]],
        model: str,
        truncate: bool | Omit = omit,
        truncation_direction: str | Omit = omit,
        ...
        Args:
          input: A string of text to be embedded.

          model: The model to use for generating vectors.

          truncate: Boolean setting whether to truncate inputs. Not supported by bridgetower.

          truncation_direction: Which direction to truncate, "Left" or "Right". Not supported by bridgetower.
