...
subtitle: Learn how to interact with AI agents in Agent Forge
description: Complete guide to the chat interface, selecting agents, managing conversations, and uploading files
---

# Chatting with Agents

Agent Forge provides an intuitive chat interface for interacting with AI agents. This guide covers everything from selecting an agent to managing conversations and uploading files.
