...
# The Python SDK takes them directly from the environment if it detects they are set.
os.environ["PREDICTIONGUARD_API_KEY"] = "<api key>"
os.environ["PREDICTIONGUARD_URL"] = "<pg url>"

# Alternatively, you can also set them when manually initializing the client.
