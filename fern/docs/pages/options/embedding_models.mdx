...
BGE-M3 is a highly versatile retrieval model excelling in **Multi-Functionality,  
Multi-Linguality, and Multi-Granularity**, making it a powerful choice for retrieval-based AI applications.  
...
- **Hybrid Retrieval:** Combines **embedding retrieval** with **sparse retrieval** (e.g., BM25) for higher accuracy and generalization.  
  - BGE-M3 inherently supports both **embedding and sparse retrieval**, allowing token weight extraction (similar to BM25)  
