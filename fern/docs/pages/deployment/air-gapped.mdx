...
You should see running services, including `pg-inside` indicating that the system has been successfully installed. The system should also show as **Healthy** in the Unified CX.

7. Deploy any desired AI models from the Models page in the Unified CX. Only **Private Models** can be deployed in air-gapped environments — Managed Models and External Models require internet access and are not available.
