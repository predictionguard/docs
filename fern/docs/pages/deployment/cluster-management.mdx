...
subtitle: Create and manage sovereign AI systems in the Unified CX
description: Guide to creating, deploying, and managing AI systems in the Prediction Guard Unified CX
---
...
For Quick Start, provide a **System Name** and optionally configure a **Public API Endpoint** for external access. See the [Quick Start guide](/unified-cx/getting-started/quick-start) for the full walkthrough.

For Custom configuration, see the [Create an AI System](/unified-cx/administration/create-an-ai-system) guide.
...
- **Models**: Deploy private, managed, or external models — see [Model Management](/unified-cx/administration/model-management)
...
- [Kubernetes](/unified-cx/installation/on-premises/kubernetes)
- [AWS](/unified-cx/installation/cloud/aws)
- [Azure](/unified-cx/installation/cloud/azure)
- [GCP](/unified-cx/installation/cloud/gcp)
- [Zero Dependency Binary](/unified-cx/installation/on-premises/binary)
- [Air Gapped](/unified-cx/installation/air-gapped/air-gapped)
