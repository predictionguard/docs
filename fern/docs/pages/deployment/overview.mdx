...
- [Docker Deployment](/deployment-administration/installation/on-premises/docker) - Container-based deployment
- [Kubernetes](/deployment-administration/installation/on-premises/kubernetes) - Orchestrated container deployment
