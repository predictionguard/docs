...
<Callout intent="info">
An **AI System** is a self-contained deployment that bundles your models, API keys, MCP servers, governance policies, and integrations into a single composable unit. Each system runs independently on your infrastructure and is managed through the Admin Console.
</Callout>
