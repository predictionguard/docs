...
slug: unified-cx/installation/on-premises/binary
---
...
## Create Your System in the Unified CX
...
You should see running pods in the namespace, including `pg-inside` indicating that the system has been successfully installed. The system should also show as **Healthy** in the Unified CX.

7. Deploy any desired AI models from the Models page in the Unified CX. Pay attention to any settings around number of AI accelerators, CPU and memory allocation to the model and ensure it fits within your VM/machine.
