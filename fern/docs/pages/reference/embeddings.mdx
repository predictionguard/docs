...
To generate embeddings, you can use the following code examples. Depending on your preference or requirements, select the appropriate method for your application. This functionality accepts text and image inputs, and supports batching multiple inputs. For images, this endpoint works with image files, urls, or base64 encoded images.
